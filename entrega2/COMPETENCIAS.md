...
### 5. Estrategia de Validación (Teoría de Conjuntos)# Informe Semana 14 - Entrega 2
...
**Solución matemática:** Split por video (conjuntos disjuntos)

**Definición:**
```
V_train = {v1, v2, ..., v14}
V_test = {v15, v16, v17, v18, v19}
...
**Justificación matemática:** Frames consecutivos son casi idénticos (diferencia < 33ms). Split por frame viola independencia de test set.

**Resultado:** Test set tiene videos COMPLETAMENTE nuevos → validación honesta.

### 6. Alternativas Consideradas y Descartadas

#### LSTM (Redes Neuronales Recurrentes)
**Por qué NO:** Dataset muy pequeño (2,625 samples). LSTM requiere miles/millones de samples. Alto riesgo de overfitting.

#### CNN (Redes Convolucionales)
**Por qué NO:** Datos tabulares (175 features), no imágenes 2D. CNN requiere estructura espacial que nuestros datos no tienen.

#### Naive Bayes (Probabilidad)
**Por qué NO:** Asume independencia condicional:
```
P(x1, x2, ..., xn | y) = P(x1|y) × P(x2|y) × ... × P(xn|y)
```
Nuestras features están correlacionadas (`knee_angle` ↔ `hip_angle`), violando el supuesto.

### 7. Análisis de Resultados (Teoría del Aprendizaje)

**Comparación con baseline:**
```
Random baseline = 1/5 = 20%
Nuestro modelo = 76.6%
Mejora = (76.6 - 20) / (100 - 20) = 70.75% hacia perfección
```

**Predicción teórica con más datos:**
...
- **Formulación rigurosa:** Problema definido formalmente como clasificación multiclase.

- **Fundamentos matemáticos:** Cada feature justificada (álgebra lineal, cálculo, trigonometría).

- **Modelos justificados:** Teoría de ensemble, kernel methods, gradient boosting aplicada correctamente.

- **Validación robusta:** Conjuntos disjuntos (teoría de conjuntos) garantizan test honesto.

- **Alternativas analizadas:** Decisiones fundamentadas en teoría de ML (no por prueba y error).

> "Como estudiantes, este proyecto nos hizo aplicar conceptos de clase (machine learning, estadística, álgebra lineal) a un problema real, y aprendimos que **la teoría sí importa en la práctica**."
